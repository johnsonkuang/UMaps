...
public final class RatTermTest {
    ...
    public void testEvalNaN() {
        ...
        assertEquals(new Double(Double.NaN), new Double(term(3, 0, 2).eval(1.0)));
    }
    ...
    public void testMultiplicationAssociativity() {
        // Whole Number Coefficient
        assertEquals(
                term(12, 5).mul(term(11, 4)).mul(term(10, 3)),
                term(10, 3).mul(term(11, 4)).mul(term(12, 5)));

        // Fractional Number Coefficient
        assertEquals(
                term(4, 9, 3).mul(term(2, 9, 2)).mul(term(1, 3, 1)),
    ...
    public void testDifferentiateMultiplicationRule() {
        // Whole Number Coefficient
        assertEquals(
                term(5, 0).mul(term(1, 3).differentiate()), (term(5, 0).mul(term(1, 3))).differentiate());
    ...
    public void testDifferentiateSumRule() {
        // Whole Number Coefficient
        assertEquals(
                ((term(5, 2)).add(term(1, 2))).differentiate(),
                (term(5, 2).differentiate()).add(term(1, 2).differentiate()));

        // Fractional Number Coefficient
        assertEquals(
                ((term(5, 2, 7)).add(term(1, 3, 7))).differentiate(),
    ...
    public void testDifferentiateSubtractionRule() {
        // Whole Number Coefficient
        assertEquals(
                ((term(5, 2)).sub(term(1, 2))).differentiate(),
                (term(5, 2).differentiate()).sub(term(1, 2).differentiate()));

        // Fractional Number Coefficient
        assertEquals(
                ((term(5, 2, 7)).sub(term(1, 3, 7))).differentiate(),
    ...
    public void testAntiDifferentiateSumRule() {
        // Whole Number Coefficient
        assertEquals(
                (term(1, 2).add(term(3, 2))).antiDifferentiate(),
                term(1, 2).antiDifferentiate().add(term(3, 2).antiDifferentiate()));

        // Fraction Coefficient
        assertEquals(
                (term(3, 4, 5).add(term(1, 2, 5))).antiDifferentiate(),
    ...
    public void testAntiDifferentiateDifferenceRule() {
        // Whole Number Coefficient
        assertEquals(
                (term(1, 2).sub(term(3, 2))).antiDifferentiate(),
                term(1, 2).antiDifferentiate().sub(term(3, 2).antiDifferentiate()));

        // Fraction Coefficient
        assertEquals(
                (term(3, 4, 5).sub(term(1, 2, 5))).antiDifferentiate(),
