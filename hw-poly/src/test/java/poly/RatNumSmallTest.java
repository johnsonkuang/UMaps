...
/**
 * This class contains a <em>small</em> set of test cases that can be used to test the
 * implementation of the RatNum class. For a more complete test, see {@link RatNumTest}. This class,
 * {@code RatNumSmallTest}, deliberately omits some of the tests from {@code RatNumTest}, to permit
 * comparing the effects of the two test suites.
 */
